...
class UNet_Attention_Transformer_Multiscale(nn.Module):
    def __init__(self,  num_classes=1, input_channels=3, deep_supervision=False,  bilinear=True):
        ...
        '''残差多尺度连接'''
        self.fuse1 = MultiConv(384, 128)
        self.fuse2 = MultiConv(192, 64)
        self.fuse3 = MultiConv(96, 32)
        self.fuse4 = MultiConv(64, 32)
