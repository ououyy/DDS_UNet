...
class Att_UNet(nn.Module):
    def __init__(self, num_classes=1, input_channels=3, deep_supervision=False, img_size=224):
        ...
        self.Att2 = Attention_block(F_g=nb_filter[0], F_l=nb_filter[0], F_int=nb_filter[0]//2)
